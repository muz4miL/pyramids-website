...
export default function Hero() {
  return (
    <section className="relative min-h-screen pt-20 lg:pt-32 pb-10 lg:pb-20 flex items-center justify-center overflow-hidden bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          {/* Left Content - FIXED MOBILE LAYOUT */}
          <motion.div
          ...
          >
            <div>
              ...
              <p className="text-base lg:text-lg text-gray-600 leading-relaxed mt-4 lg:mt-6 max-w-2xl mx-auto lg:mx-0">
            ...
            <motion.div
              ...
              className="flex flex-col sm:flex-row items-center gap-6 lg:gap-16 justify-center lg:justify-start"
            >
              {/* Left Text Block */}
          ...
          {/* Right Stats Box - FIXED MOBILE POSITIONING */}
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, delay: 0.2 }}
            className="relative flex justify-center items-center lg:-mr-50 mt-8 lg:mt-0 lg:mb-40"
          >
            <div className="relative w-full max-w-sm lg:max-w-lg">
              ...
              {/* FIXED MOBILE TEXT POSITIONING */}
              <div className="absolute inset-0 flex flex-col justify-center items-center lg:items-end text-white p-4 lg:p-8 lg:ml-32 lg:mt-10">
                <h3 className="text-lg sm:text-xl lg:text-4xl font-extrabold mb-3 lg:mb-8 text-center font-serif">
                  ENGINEERING EXCELLENCE:
                  <br /> OUR LEGACY
                </h3>
                <div className="grid grid-cols-2 gap-3 lg:gap-6 w-full max-w-xs lg:max-w-none mt-4 lg:mt-12 lg:mr-16">
                  <div className="text-center">
                    <p className="text-2xl sm:text-3xl lg:text-6xl font-bold text-white font-serif">
                      250+
                    </p>
                    <p className="text-xs sm:text-sm text-gray-200 mt-1 lg:mt-2">
